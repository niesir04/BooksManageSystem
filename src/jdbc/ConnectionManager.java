...
public class ConnectionManager {
     ...
     * 连接数据库的四大必需属性
     */
    private static final String driver = "com.mysql.cj.jdbc.Driver";//加载驱动类
    private static final String url = "jdbc:mysql://localhost:3306/book";//构建连接参数
    private static final String user = "root";
    private static final String psd = "nzjd305913.";
